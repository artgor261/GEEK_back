		...
		Questions: []*Question{
			{
				...
				TrueAnswer: `"Топ-3 по риску:
							Молибден: β = 20.53 - экстремально высокий риск
							Нефть: β = 0.33 - низкий риск
							Серебро: β = 0.22 - низкий риск
							Уголь: β = 0.06 - минимальный риск
							Цинк: β = -0.07 - движется против рынка"`,
				MaxScore:   10,
			},
			{
				ID: 2,
			...
			{
				ID:       4,
				Text:     `"Расставь знаки препинания: научно-технический прогресс не социальный \
				 	принесет счастья если не будет дополняться чрезвычайно глубокими изменениями в \
					социальной нравственной и культурной жизни человечества внутреннюю духовную жизнь \
					людей внутренние импульсы их активности трудней всего прогнозировать но именно от \
					этого зависит в конечном итоге и гибель и спасение цивилизации"`,
				TrueAnswer: `"Научно-технический прогресс не социальный принесёт счастья, если не будет дополняться \
					чрезвычайно глубокими изменениями в социальной, нравственной и культурной жизни \ 
					человечества. Внутреннюю духовную жизнь людей, внутренние импульсы их активности \
					трудней всего прогнозировать, но именно от этого зависит в конечном итоге и гибель, \
					и спасение цивилизации."`,
				MaxScore: 10,
			},
			{
				ID: 5,
				Text: `"Двойная звезда имеет период Т = 3 года, а расстояние L между ее компонентами \
					равно двум астрономическим единицам. Вырази массу звезды через массу Солнца и сократи \
			...
			},
			{
				...
				TrueAnswer: "Анна или Борис взяли конфету",
			},
		},
		NumOfQuestions: 6,
	}
