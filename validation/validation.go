...
func (g *GigaChat) ValidAnswer(token, userAnswer, rightAnswer, question string, history []*openai.Message) ([]Choice, error) {
	...
	к правильному ответу. Если пользователь ничего не ответил или ответ вообще не связан с вопросом, \
	то ставь оценку равную нулю. Так же не забывай оценить ещё и историю диалога \
